...
> Конкретно его исходные файлы находятся в каталогах [src/ru/OInt](https://github.com/oscript-library/oint/tree/main/src/ru/OInt) и [src/en/OInt](https://github.com/oscript-library/oint/tree/main/src/en/OInt)<br>
> <br> 
